 ...
 * @author Paul
 */
public class ChatCellRender extends JLabel implements ListCellRenderer{
    ...
    public ChatCellRender() throws MalformedURLException, IOException {
        setOpaque(true);
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
       ...
       pnl.removeAll();
        ...
        pnl.add(new ChatObject(value.toString()));
